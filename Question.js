class Question {
  ...
  display(){
    this.title.html("My Riddle Game");
    ...
    this.question.html("Question:- What has to be broken before you can use it? " );
    // question.html("Question:- What starts and ends with the letter ‘E’, but has only one letter? " );

    this.question.position(150, 80);
    this.option1.html("1: Light Stick " );
    this.option1.position(150, 100);
    this.option2.html("2: Egg" );
    this.option2.position(150, 120);
    this.option3.html("3: Can Of Beans " );
    this.option3.position(150, 140);
    this.option4.html("4: FireWood" );
    ...
    this.button.mousePressed(()=>{
       ...
       this.message.html("The Correct Awnser Was B. An Egg.Thank You For Playing!");
